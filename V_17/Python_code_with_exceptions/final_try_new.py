...
Flag = False
doc1 = 'gowtham-train-2.txt'
doc2 = 'gowtham-test-2.txt'
...
#                    if j.isalnum():
            ...
            if not words_to_be_searched_stop_rem:
                ...
                if (pattern_matching_verb_pos(sentences, [search_sentence_list[i]])[0] == [] and
                    ...
                    with open('Uniq_Final_Sentences_Lenient.txt', 'a',  encoding = 'utf-8-sig') as f:
                    ...
                    with open('Uniq_Final_Sentences_Moderate.txt', 'w', encoding = 'utf-8-sig') as f:
                    ...
                    # writing Uniq_Final_Sentences_Moderate locally to a text file
                    with open('Uniq_Final_Sentences_Strict.txt', 'w', encoding = 'utf-8-sig') as f:
