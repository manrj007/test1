...
os.chdir('C:\\Users\\ArgusMLPOC_Admin\\Desktop\\Argus\\Final_demo\\backup\\V_1.5\\Python_code_with_exceptions\\')
# os.chdir('C:\\Users\\Administrator\\Desktop\\Argus\\Argus\\Python_code_with_exceptions') # VM PATH
...
trainingPath = 'C:\\Users\\ArgusMLPOC_Admin\\Desktop\\Argus\\Final_demo\\backup\\V_1.5\\Middleware\\training\\'
testingPath = 'C:\\Users\\ArgusMLPOC_Admin\\Desktop\\Argus\\Final_demo\\backup\\V_1.5\\Middleware\\testing\\'
...
Flag = False
#doc1 = 'Training_document (2).txt'
#doc2 = 'Jordan_test_doc1.txt'
...
#        print('textloaded    :   ', text_loaded)
    ...
    ###############################################################################    
        ...
        # Lenient Mode Output
        Final_Sentences_Lenient = [pattern_matching_verb_pos(tokens_sentences, search_sentence_list)[0] + 
                                   pattern_matching_verb_entity(tokens_sentences, search_sentence_list)[0] +
                                   bqm_sent(tokens_sentences, search_sentence_list) + 
        ...
        Final_Sentences_Moderate = [pattern_matching_verb_pos(tokens_sentences, search_sentence_list)[1] + 
                                    pattern_matching_verb_entity(tokens_sentences, search_sentence_list)[1] +
                                    bqm_sent(tokens_sentences, search_sentence_list) + 
        ...
        # Strict Mode Output
        Final_Sentences_Strict = [pattern_matching_verb_pos(tokens_sentences, search_sentence_list)[2] + 
                                  pattern_matching_verb_entity(tokens_sentences, search_sentence_list)[2] +
                                  bqm_sent(tokens_sentences, search_sentence_list) + 
